...
export default function RiesgoPaisCard({ riesgoPais }) {
  ...
  return (
    <Card className="group border-t-4 !border-t-orange-200 p-6 hover:!border-t-orange-500 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
