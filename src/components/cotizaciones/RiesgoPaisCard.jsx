            ...
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-5 w-5">
                <path
                  ...
                  d="M12 21c4.97 0 9-2.24 9-5v-8c0-2.76-4.03-5-9-5s-9 2.24-9 5v8c0 2.76 4.03 5 9 5zM3 12c0 2.76 4.03 5 9 5s9-2.24 9-5"
                />
              </svg>
            </div>
            <div>
              <p className="text-sm text-slate-500">Reservas brutas (BCRA)</p>
              <p className="mt-1 text-2xl font-bold text-slate-900">USD {formatMillones(reservas.valor)} M</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
