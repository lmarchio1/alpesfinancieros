    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="animate-fade-up" style={{ animationDelay: '0ms' }}>
          {interanual !== null ? (
            <Card className="group h-full border-t-4 !border-t-brand-200 p-6 hover:!border-t-brand-500 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
        ...
        <div className="animate-fade-up" style={{ animationDelay: '80ms' }}>
          {rem ? (
            <Card className="group h-full border-t-4 !border-t-[#ecd7bb] p-6 hover:!border-t-[#c17a1e] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
              <div className="flex items-center gap-3">
        ...
        <div className="animate-fade-up" style={{ animationDelay: '160ms' }}>
          {plazoFijo ? (
            <Card className="group h-full border-t-4 !border-t-emerald-200 p-6 hover:!border-t-emerald-500 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
