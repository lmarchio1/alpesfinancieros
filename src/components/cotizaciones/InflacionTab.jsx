  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {rem && (
          <Card className="group border-t-4 !border-t-[#c17a1e] p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
            <div className="flex items-center gap-3">
        ...
        {plazoFijo && (
          <Card className="group border-t-4 !border-t-emerald-500 p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
