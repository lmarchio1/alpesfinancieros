...
export default function DolarEsperadoCard() {
  ...
  if (!rem) {
    return (
      <Card className="border-t-4 border-emerald-600 !bg-[#E9EEE7] p-6">
  ...
  return (
    <Card className="group border-t-4 border-emerald-600 !bg-[#E9EEE7] p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
      <div className="flex items-center gap-3">
