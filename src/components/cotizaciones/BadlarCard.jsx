...
export default function BadlarCard() {
  ...
  return (
    <Card className="group border-t-4 !border-t-violet-800 p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/70">
