  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5 lg:items-start lg:gap-x-20">
          <div
            ref={formRef}
            className={`order-2 lg:order-1 lg:col-span-3 rounded-2xl bg-white/10 p-6 backdrop-blur-sm transition-all duration-700 ease-out motion-reduce:transition-none sm:p-8 ${
